...
import { getDishDetails, newReview, clearErrors } from '../../actions/dishActions'
import { addItemToCart } from '../../actions/cartActions'
import { NEW_REVIEW_RESET } from '../../constants/dishConstants'
...
const DishDetails = ({ match }) => {
    ...
    const reviewHandler = () => {
        ...
        formData.set('dishId', match.params.id);
                ...
                <Fragment>
                    ...
                    <div className="row d-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4" disabled={dish.stock === 0} onClick={addToCart}>Add to Cart</button>
                            ...
                            <hr />
                            <p id="dish_restaurant mb-3">Sold by: <strong>{dish.restaurant}</strong></p>
                    ...
                    {dish.reviews && dish.reviews.length > 0 && (
                        <ListReviews reviews={dish.reviews} />
                    )}
